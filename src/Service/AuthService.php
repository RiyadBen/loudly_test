...
class AuthService
{
    ...
    public function __construct(RequestStack $requestStack, $jwtSecretKey,UserService $userService)
    {
    ...
    public function isAuthenticated()
    {
        ...
        return !empty($decoded_array) && $this->userService->getUser($decoded_array["email"]) instanceof User;
    }
